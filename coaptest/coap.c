...
static const coap_endpoint_path_t path_servo_h = { 2, {"periph", "servoh"} };

static const coap_endpoint_path_t path_servo_v = { 2, {"periph", "servov"} };

static const coap_endpoint_path_t path_laser = { 2, {"periph", "laser"} };

static const coap_endpoint_path_t path_testled = { 2, {"periph", "testled"} };
